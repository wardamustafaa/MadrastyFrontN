...
import { StudentMatterComponent } from './pages/components/StudentMatter/StudentMatter.component';
import { StudentSequenceComponent } from './pages/components/StudentSequenceInClass/StudentSequenceInClass.component';
import { StudentTrackComponent } from './pages/components/StudentTracking/StudentTracking.component';
import { SupervisordisComponent } from './pages/components/SupervisorsDistribution/SupervisorsDistribution.component';
import { WritingPrepComponent } from './pages/components/WritingPreparation/WritingPreparation.component';
...
const routes: Routes = [
  ...
  {path:'StudentMatterComponent',component: StudentMatterComponent},
  {path:'StudentSequenceComponent',component: StudentSequenceComponent},
  {path:'StudentTrackComponent',component: StudentTrackComponent},
  {path:'SupervisordisComponent',component: SupervisordisComponent},
  {path:'WritingPrepComponent',component: WritingPrepComponent}
];
